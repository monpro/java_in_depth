...
public class EmptyCollectionsReturn {

    private final List<Integer> stocks = new ArrayList<>();

    /**
     * This is not a good design
     * you always need to use explicit null check to handle the possibly null value
     * @return a list containing all of the stocks
     * or null if there is no stocks
     */
    ...
    /**
     * This optimisation avoid the allocations by returning the same immutable empty collection repeatedly,
