...
class PausableThreadPool extends ThreadPoolExecutor {

  private final ReentrantLock reentrantLock = new ReentrantLock();
  private boolean isPaused;
  private Condition unpaused = reentrantLock.newCondition();

  private PausableThreadPool(
      int corePoolSize,
      int maximumPoolSize,
      long keepAliveTime,
      TimeUnit unit,
  ...
  public static void main(String[] args) throws InterruptedException {
    PausableThreadPool pausableThreadPool =
        new PausableThreadPool(10, 20, 100, TimeUnit.SECONDS, new LinkedBlockingQueue<>());
